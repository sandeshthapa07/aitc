...
const HeadingSection = () => {
  return (
    <div className='flex flex-col items-center  gap-10 lg:items-start lg:gap-[3.25rem]'>
      <h2 className='text-center text-[2rem] font-black lg:text-5xl'>Tailored Services for Modern Solutions</h2>
