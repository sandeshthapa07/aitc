...
const MainHeader = () => {
  ...
  return (
    <div className='w-full'>
      <nav className='header relative  flex w-full flex-row items-center  justify-between border-t-2 border-lightShade1 p-6 xmd:flex-row  xmd:justify-between xmd:px-16 lg:py-0  3xl:px-[9.375rem]  '>
        <Link href='/'>
          <svg
            width='48'
            height='61'
        ...
        <div className='hidden h-full flex-row items-center  lg:flex'>
          <button
            className='h-full px-16  py-6 text-lg   text-mainBlack'
            onMouseEnter={(e) => {
              e.preventDefault();
          ...
          <div className='h-full flex-row items-center  gap-16 lg:flex'>
      ...
      <div className='relative w-full'>
        {showServices && <DesktopServices setShowServices={setShowServices} />}
      </div>
    </div>
  );
};
